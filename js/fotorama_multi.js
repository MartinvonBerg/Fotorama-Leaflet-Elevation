...
(function (window, document, undefined) {
    ...
    if (numberOfboxes > 0) {
        ...
        var hasMap = document.querySelectorAll('[id^=boxmap]').length;
        ...
        */
        ...
        for (var i = 0; i < numberOfboxes; i++) {
            ...
            var numberOfFotorama = document.querySelectorAll('[id^=mfotorama'+i+']').length;

            if (numberOfFotorama == 1) {
                ...
                var newimages = phpvars[i].imgdata; 
                var olddata = fotorama[i].data;
                var newdata = [];
