...
final class FotoramaElevationAdmin
{
	...
	public function fm_admin_scripts_enqueue() {
		...
		wp_enqueue_script('fotorama_admin',  $plugin_path . 'build/fm_admin/fm_admin.js', ['jquery'], '0.29.0', true);
		wp_enqueue_style('fm-admin-gpx', $plugin_path . 'css/fm_admin_gpx.css',[] ,'0.29.0' ,'all');
