...
final class FotoramaElevationAdmin
{
	...
	private $leafletSettings = [
		...
		'param15' => [
			"label" => "chartjspadding",
			"text" => "Padding of Chart in px*",
			"class" => "leaflet_row",
			"custom_data" => "custom14",
			"type" => "number",
			"values" => 20,
			...
			"max" => 50,
			"description" => "",
			"shortcode" => "chartjspadding",
			"info" => "Padding of Chart in px (from border to chart canvas)"
		],
		'param9' => [
		...
		'param17' => [
			'label' => 'trackcolour',
			'text' => 'Colour of (first) Track*',
			'class' => 'leaflet_row',
			'custom_data' => 'custom17',
			'type' => 'color',
			'values' => '#FF0000',
			'default' => '#FF0000',
			'description' => 'Track (start) colour defined by a valid CSS name',
			'shortcode' => 'trackcolour',
			'info' => 'Track (start) colour defined by a valid CSS name',
		],
		'param1' => [
	...
	public function fm_admin_scripts_enqueue() {
		...
		wp_enqueue_script('fotorama_admin',  $plugin_path . 'build/fm_admin/fm_admin.js', ['jquery'], '0.35.0', true);
		wp_enqueue_style('fm-admin-gpx', $plugin_path . 'css/fm_admin_gpx.css',[] ,'0.35.0' ,'all');
