...
function wp_gpxviewer_scripts()
{
  ...
  if (!is_front_page() || !is_home()) {
    ...
    // Load Styles
    wp_enqueue_style('wp_gpxviewer_style1', $plugin_url . 'css/fotorama_multi.css');
    wp_enqueue_style('fr-style1', $plugin_url . 'css/fotorama3.css');
    ...
    wp_enqueue_script('fr-script1', $plugin_url . 'js/fotorama3.min.js', array('jquery'), '1.10.2', true);
    wp_enqueue_script('wp_gpxviewer_script2', $plugin_url . 'js/fotorama_multi.js', array('jquery'), '1.10.2', true);
  }
}
