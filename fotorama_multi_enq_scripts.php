...
if ( 'true' == $useCDN ) {
	...
	wp_register_style('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.5.1', true);	
} else {
	...
	wp_register_script('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.5.1', true);
