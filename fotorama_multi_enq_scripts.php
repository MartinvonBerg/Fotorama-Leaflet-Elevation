...
if ( 'true' == $useCDN ) {
	...
	// register Scripts
	wp_register_style('d3_js', 'https://cdnjs.cloudflare.com/ajax/libs/d3/5.16.0/d3.min.js', array('jquery'), '5.16.0'); // 6.6.0 does not work with d3 > version 6.0 !
	wp_register_style('leaflet_js', 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/leaflet.min.js', array('jquery'), '1.7.1'); // aktuell
	wp_register_style('gpx_js', 'https://cdnjs.cloudflare.com/ajax/libs/leaflet-gpx/1.5.1/gpx.min.js', array('jquery'), '1.5.1'); // aktuell
	wp_register_style('leaflet_gpxgroup_js', $plugin_url . 'js/libs/leaflet-gpxgroup.min.js', array('jquery'), '');
	wp_register_style('leaflet_elevation_js', 'https://unpkg.com/@raruto/leaflet-elevation@1.5.6/dist/leaflet-elevation.min.js', array('jquery'), '1.5.6'); // 1.6.7
	wp_register_style('leaflet_gesture_handling_js', 'https://unpkg.com/leaflet-gesture-handling/dist/leaflet-gesture-handling.min.js', array('jquery'), '1.2.1'); // 1.2.1
	wp_register_style('control_fullscreen_js','https://cdnjs.cloudflare.com/ajax/libs/leaflet.fullscreen/2.0.0/Control.FullScreen.min.js', array('jquery'), '2.0.0'); // aktuell
	wp_register_style('zoom_master_js','https://cdnjs.cloudflare.com/ajax/libs/jquery-zoom/1.7.21/jquery.zoom.min.js', array('jquery'), '1.7.21'); // aktuell
	wp_register_style('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.6.1');	
} else {
	...
	wp_register_script('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.6.1');
