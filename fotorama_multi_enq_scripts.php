...
if ( 'true' == $useCDN ) {
	...
	wp_register_style('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.8.0');	
	...
	wp_register_script('fotorama_multi_js',  $plugin_url . 'js/fotorama_multi.min.js', array('jquery'), '0.8.0');
}
