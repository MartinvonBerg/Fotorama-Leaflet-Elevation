...
function showmulti($attr, $content = null)
{
	...
	\wp_enqueue_style('swiperCss', $plugin_path . 'js/swiperClass.min.css',[],'0.22.0','all');
	\wp_enqueue_style('swiperThumbsCss', $plugin_path . 'js/thumbnailClass.min.css',[],'0.22.0','all');
...
EOF;
	...
	wp_enqueue_script('fotorama_main_bundle',  $plugin_path . 'build/fm_bundle/fm_main.js', ['jquery'], '0.22.0', true);
